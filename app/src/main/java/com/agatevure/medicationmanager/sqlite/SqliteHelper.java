package com.agatevure.medicationmanager.sqlite;
...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    public static final String Col_6 = "interval";
    public static final String Col_7 = "startDate1";
    public static final String Col_8 = "endDate1";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTableQuery = "create table if not exists " + TableName + " ( ToDoID INTEGER PRIMARY KEY AUTOINCREMENT, ToDoTaskDetails TEXT, ToDoTaskPrority TEXT, ToDoTaskStatus TEXT, ToDoNotes TEXT,interval TEXT, startDate1 TEXT, endDate1 TEXT )";
    ...
    public Cursor updateTask(ToDoData td) {
        ...
        String query = "UPDATE "
                ...
                + "', "
                + Col_6 + "='" + td.getInterval()
                + "', "
                + Col_7 + "='" + td.getStartDate1()
                + "', "
                + Col_8 + "='" + td.getEndDate1()
